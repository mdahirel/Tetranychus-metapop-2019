...
Then we build the formulas for both the patch by patch multivariate model and the metapopulation total univariate model:
...
P_formula <- mvbf(
      bf(P11 ~ 0 + TREATMENT + (1 | METAPOP_ID) + (1 | P | gr(METAPOP_ID:WEEK, by = METAPOP_ID)), family = poisson),
      bf(P12 ~ 0 + TREATMENT + (1 | METAPOP_ID) + (1 | P | gr(METAPOP_ID:WEEK, by = METAPOP_ID)), family = poisson),
      bf(P13 ~ 0 + TREATMENT + (1 | METAPOP_ID) + (1 | P | gr(METAPOP_ID:WEEK, by = METAPOP_ID)), family = poisson),
      bf(P21 ~ 0 + TREATMENT + (1 | METAPOP_ID) + (1 | P | gr(METAPOP_ID:WEEK, by = METAPOP_ID)), family = poisson),
      bf(P22 ~ 0 + TREATMENT + (1 | METAPOP_ID) + (1 | P | gr(METAPOP_ID:WEEK, by = METAPOP_ID)), family = poisson),
      bf(P23 ~ 0 + TREATMENT + (1 | METAPOP_ID) + (1 | P | gr(METAPOP_ID:WEEK, by = METAPOP_ID)), family = poisson),
      bf(P31 ~ 0 + TREATMENT + (1 | METAPOP_ID) + (1 | P | gr(METAPOP_ID:WEEK, by = METAPOP_ID)), family = poisson),
      bf(P32 ~ 0 + TREATMENT + (1 | METAPOP_ID) + (1 | P | gr(METAPOP_ID:WEEK, by = METAPOP_ID)), family = poisson),
      bf(P33 ~ 0 + TREATMENT + (1 | METAPOP_ID) + (1 | P | gr(METAPOP_ID:WEEK, by = METAPOP_ID)), family = poisson)
)

M_formula <- bf(METAPOPSUM ~ 0 + TREATMENT + (1|METAPOP_ID) + (1|METAPOP_ID:WEEK), family = poisson)
```
