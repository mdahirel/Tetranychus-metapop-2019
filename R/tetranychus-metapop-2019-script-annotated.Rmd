...
In the next code chunk, I've made a function that takes a `brms` model as input and give all metrics we need as output (it only works correctly on one of the models that can be specified via the script above, of course).
