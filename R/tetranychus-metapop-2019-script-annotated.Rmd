...
The way the dataset is now, one row = one snapshot of one of the metapopulations (i.e. its state at one time point). We finish by adding a metapopulation total column, which may be useful for some comparisons:
