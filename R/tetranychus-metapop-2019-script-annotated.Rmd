...
It's fairly easy to see that the negative binomial model for patches clearly misses the fact that the whole metapopulation varies somewhat synchronously from week to week, and is thus incomplete.
