...
if (is.na(which.trt) == TRUE) {
  prior <- c(
    ...
    set_prior("lkj(2)", class = "cor") # very skeptical of very high correlations (positive or negative)
  )
}
...
compare_levels(subset(tab_results, gamma < 5), variable = "gamma", by = TREATMENT,
               comparison = list(c("16.NO", "16.R"), c("8.NO", "8.R"), c("4.NO", "4.R"))) %>%
  ggplot() +
...
p11 <- ggplot(subset(tab_results,was.random == "NO")) +
  geom_density(aes(metapopNmean, fill = Length), alpha = 0.5) +
  guides(fill = FALSE) +
  facet_grid(Length~., labeller = as_labeller(c("4" = "4", "8" = "8", "16" = "16"))) +
  labs(x = "Metapopulation mean density") + theme_bw() +
  theme(text=element_text(size = 20))

p12 <- compare_levels(subset(tab_results, alpha < 20), variable = "alpha", by = TREATMENT,
               comparison = list(c("16.NO", "8.NO"), c("16.NO", "4.NO"), c("8.NO", "4.NO"))) %>%
  ggplot() +
  geom_halfeyeh(aes(y = TREATMENT, x = alpha), trim = FALSE, scale = "area") +
  geom_vline(xintercept = 0) +
  theme_bw() + labs(x = "Alpha variability", y = "Comparisons") +
...
p13 <- compare_levels(tab_results, variable = "beta1", by = TREATMENT,
               comparison = list(c("16.NO", "8.NO"), c("16.NO", "4.NO"), c("8.NO", "4.NO"))) %>%
  ggplot() +
  geom_halfeyeh(aes(y = TREATMENT, x = beta1), trim = FALSE, scale = "area") +
  geom_vline(xintercept = 0) +
...
p14 <- compare_levels(subset(tab_results, gamma < 10), variable = "gamma", by = TREATMENT,
               comparison = list(c("16.NO", "8.NO"), c("16.NO", "4.NO"), c("8.NO", "4.NO"))) %>%
  ggplot() +
  geom_halfeyeh(aes(y = TREATMENT, x = gamma), trim = FALSE, scale = "area") +
  geom_vline(xintercept = 0) +
...
ggarrange(p11, p12, p13, p14, labels = c("A", "B", "C", "D"), ncol = 2, nrow = 2)

# block 2

p21 <- ggplot(subset(tab_results,was.random == "R")) +
  geom_density(aes(metapopNmean, fill = Length), alpha = 0.5) +
  guides(fill = FALSE) +
  facet_grid(Length~., labeller = as_labeller(c("4" = "4", "8" = "8", "16" = "16"))) +
  labs(x = "Metapopulation mean density") + theme_bw() +
...
p22 <- compare_levels(subset(tab_results, alpha < 10), variable = "alpha", by = TREATMENT,
               comparison = list(c("16.R", "8.R"), c("16.R", "4.R"), c("8.R", "4.R"))) %>%
  ggplot() +
  geom_halfeyeh(aes(y = TREATMENT, x = alpha), trim = FALSE, scale = "area") +
  geom_vline(xintercept = 0) +
...
p23 <- compare_levels(tab_results, variable = "beta1", by = TREATMENT,
               comparison = list(c("16.R", "8.R"), c("16.R", "4.R"), c("8.R", "4.R"))) %>%
  ggplot() +
  geom_halfeyeh(aes(y = TREATMENT, x = beta1), trim = FALSE, scale = "area") +
  geom_vline(xintercept = 0) +
...
p24 <- compare_levels(subset(tab_results, gamma < 5), variable = "gamma", by = TREATMENT,
               comparison = list(c("16.R", "8.R"), c("16.R", "4.R"), c("8.R", "4.R"))) %>%
  ggplot() +
  geom_halfeyeh(aes(y = TREATMENT, x = gamma), trim = FALSE, scale = "area") +
  geom_vline(xintercept = 0) +
...
ggarrange(p21, p22, p23, p24, labels = c("A", "B", "C", "D"), ncol = 2, nrow = 2)

# block 3

p31 <- compare_levels(tab_results, variable = "metapopNmean", by = TREATMENT,
               comparison = list(c("16.NO", "16.R"), c("8.NO", "8.R"), c("4.NO", "4.R"))) %>%
  ggplot() +
  geom_halfeyeh(aes(y = TREATMENT, x = metapopNmean), trim = FALSE) +
  geom_vline(xintercept = 0) +
  theme_bw() + labs(x = "Metapopulation mean density", y = "Comparisons") +
  theme(text=element_text(size = 20))

p32 <- compare_levels(subset(tab_results, alpha < 10), variable = "alpha", by = TREATMENT,
               comparison = list(c("16.NO", "16.R"), c("8.NO", "8.R"), c("4.NO", "4.R"))) %>%
  ggplot() +
  geom_halfeyeh(aes(y = TREATMENT, x = alpha), trim = FALSE) +
  geom_vline(xintercept = 0) +
  theme_bw() + labs(x = "Alpha variability", y = "") +
  theme(text=element_text(size = 20))

p33 <- compare_levels(tab_results, variable = "beta1", by = TREATMENT,
               comparison = list(c("16.NO", "16.R"), c("8.NO", "8.R"), c("4.NO", "4.R"))) %>%
  ggplot() +
  geom_halfeyeh(aes(y = TREATMENT, x = beta1), trim = FALSE) +
  geom_vline(xintercept = 0) +
  theme_bw() + labs(x = "Beta variability", y = "Comparisons") +
  theme(text=element_text(size = 20))

p34 <- compare_levels(subset(tab_results, gamma < 5), variable = "gamma", by = TREATMENT,
               comparison = list(c("16.NO", "16.R"), c("8.NO", "8.R"), c("4.NO", "4.R"))) %>%
  ggplot() +
  geom_halfeyeh(aes(y = TREATMENT, x = gamma), trim = FALSE) +
  geom_vline(xintercept = 0) +
  theme_bw() + labs(x = "Gamma variability", y = "") +
  theme(text=element_text(size = 20))

ggarrange(p31, p32 + rremove("y.text"), p33, p34  + rremove("y.text"), labels = c("A", "B", "C", "D"), ncol = 2, nrow = 2)
...
```{r simple_graphs}
require(ggpubr)
p11 <- ggplot(filter(tab_results, was.random == "NO")) +
    stat_halfeyeh(aes(y = Length, x = metapopNmean, fill = Length)) +
    guides(fill = FALSE) + scale_fill_manual(values = c("#D55E00", "#E69F00", "#F0E442")) +
    labs(x = "Metapopulation mean density") + theme_bw() +
  theme(text=element_text(size = 20))

p12 <- ggplot(filter(tab_results, was.random == "NO" & alpha < quantile(alpha, 0.99))) +
    stat_halfeyeh(aes(y = Length, x = alpha, fill = Length)) +
    guides(fill = FALSE) + scale_fill_manual(values = c("#D55E00", "#E69F00", "#F0E442")) +
    labs(x = "Alpha variability") + theme_bw() +
  theme(text=element_text(size = 20))
  
p13 <- ggplot(filter(tab_results, was.random == "NO")) +
    stat_halfeyeh(aes(y = Length, x = beta1, fill = Length)) +
    guides(fill = FALSE) + scale_fill_manual(values = c("#D55E00", "#E69F00", "#F0E442")) +
    labs(x = "Beta variability") + theme_bw() +
  theme(text=element_text(size = 20))

p14 <- ggplot(filter(tab_results, was.random == "NO" & gamma < quantile(gamma, 0.99))) +
    stat_halfeyeh(aes(y = Length, x = gamma, fill = Length)) +
    guides(fill = FALSE) + scale_fill_manual(values = c("#D55E00", "#E69F00", "#F0E442")) +
    labs(x = "Gamma variability") + theme_bw() +
  theme(text=element_text(size = 20))

ggarrange(p11, p12 + rremove("y.text"), p13, p14  + rremove("y.text"), labels = c("A", "B", "C", "D"), ncol = 2, nrow = 2)

p21 <- ggplot(filter(tab_results, was.random == "R")) +
    stat_halfeyeh(aes(y = Length, x = metapopNmean, fill = Length)) +
    guides(fill = FALSE) + scale_fill_manual(values = c("#D55E00", "#E69F00", "#F0E442")) +
    labs(x = "Metapopulation mean density") + theme_bw() +
  theme(text=element_text(size = 20))

p22 <- ggplot(filter(tab_results, was.random == "R" & alpha < quantile(alpha, 0.99))) +
    stat_halfeyeh(aes(y = Length, x = alpha, fill = Length)) +
    guides(fill = FALSE) + scale_fill_manual(values = c("#D55E00", "#E69F00", "#F0E442")) +
    labs(x = "Alpha variability") + theme_bw() +
  theme(text=element_text(size = 20))
  
p23 <- ggplot(filter(tab_results, was.random == "R")) +
    stat_halfeyeh(aes(y = Length, x = beta1, fill = Length)) +
    guides(fill = FALSE) + scale_fill_manual(values = c("#D55E00", "#E69F00", "#F0E442")) +
    labs(x = "Beta variability") + theme_bw() +
  theme(text=element_text(size = 20))

p24 <- ggplot(filter(tab_results, was.random == "R" & gamma < quantile(gamma, 0.99))) +
    stat_halfeyeh(aes(y = Length, x = gamma, fill = Length)) +
    guides(fill = FALSE) + scale_fill_manual(values = c("#D55E00", "#E69F00", "#F0E442")) +
    labs(x = "Gamma variability") + theme_bw() +
  theme(text=element_text(size = 20))

ggarrange(p21, p22 + rremove("y.text"), p23, p24  + rremove("y.text"), labels = c("A", "B", "C", "D"), ncol = 2, nrow = 2)

lvar_graph <- lvar_result %>%
  select(1,3:6,10,11) %>%
  gather("position", "mean", 4:6) %>%
  mutate(position = substring(position, 7))

ggplot(lvar_graph) +
  stat_halfeyeh(aes(y = Length, x = mean, fill = position), alpha = .75) +
  facet_grid(was.random ~., labeller = as_labeller(c("NO" = "non-random", "R" = "random"))) +
  theme_bw()  +  labs(y = "connectedness", x = "mean local density") +
  scale_fill_discrete(name = "local connectedness",
    breaks = c("center", "corners", "sides"),
    labels = c("center", "corner", "edge")) +
  theme(text=element_text(size = 20), legend.position = "bottom")
```
# Extra
