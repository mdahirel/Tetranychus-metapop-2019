...
left_join(M_tab,P_tab_M) %>% 
  ...
  scale_y_continuous("metapopulation size (metapopulation model predictions)",limits=c(80,420))+
  scale_x_continuous("metapopulation size (patch model predictions)",limits=c(80,420)) +
  cowplot::theme_half_open(11) +
  cowplot::background_grid(colour.major = "grey95", colour.minor = "grey95")+
