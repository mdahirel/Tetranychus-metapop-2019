...
The following plots describe the outcome of posterior pairwise comparisons between treatments, regarding local population sizes (**Fig. S06-1** and **S06-2**, match with main text **Figs 1-2**) and variability metrics (**Fig. S06-3** and **S06-4**, matches with main text **Fig. 4**). In all cases, comparisons are ratios, and dots and segments represent the posterior mean and 95% Highest Density Interval.

```{r pairwise_comp_fig1, fig.width=5, fig.height=7}
...
**Figure S06.1** -- Effects of connectedness and randomization on local population size. For each treatment variable the effects of the others are pooled.


**Figure S06.2** -- Effects of connectedness and randomization on local population size.


**Figure S06.3** -- Effect of randomization on variability metrics

**Figure S06.4** -- Effect of landscape connectedness on veriability metrics
